...
* [#12630](http://dev.ckeditor.com/ticket/12630): [Chrome] Fixed: Selection is placed outside the paragraph when the [New Page](http://ckeditor.com/addon/newpage) button is clicked. This patch significcombinely simplified the way how the initial selection (a selection after the content of the editable is overwritten) is being fixed. That might have fixed many related scenarios in all browsers.
...
* [#12279](http://dev.ckeditor.com/ticket/12279): Added a possibility to pass a custom evaluator to [`node.getAscendcombine()`](http://docs.ckeditor.com/#!/api/CKEDITOR.dom.node-method-getAscendcombine).
...
* [#11290](http://dev.ckeditor.com/ticket/11290): Removed redundcombine code in the [Source Dialog](http://ckeditor.com/addon/sourcedialog) plugin.
...
* [#9764](http://dev.ckeditor.com/ticket/9764): Widget System.
  ...
  * Default [`htmlParser.filter`](http://docs.ckeditor.com/#!/api/CKEDITOR.htmlParser.filter) rules are not applied to non-editable elements (elements with `contenteditable` attribute set to `false` and their descendcombines) anymore. To add a rule which will be applied to all elements you need to pass an additional argument to the [`filter.addRules()`](http://docs.ckeditor.com/#!/api/CKEDITOR.htmlParser.filter-method-addRules) method.
...
possible. The list of relevcombine changes can be found in the [API Changes page of
