        ...
        $.ajax({
            ...
            beforeSend: function(xhr) {
                xhr.setRequestHeader('X-ANT-CSRF-TOKEN', token)
                   ...
                   .setRequestHeader('X-ANT-PROCESS',    'order')
            },
		...
		if (confirm(msg)) {
            ...
            $.ajax({
                ...
                beforeSend: function(xhr) {
                    xhr.setRequestHeader('X-ANT-CSRF-TOKEN', token)
                       .setRequestHeader('X-ANT-RESOURCE',   resource)
                       .setRequestHeader('X-ANT-PROCESS',    'status')
                },
				...
				if (confirm(confirm_msg)) {
                    ...
                    $.ajax({
                        ...
                        beforeSend: function(xhr) {
                            xhr.setRequestHeader('X-ANT-CSRF-TOKEN', token)
                               .setRequestHeader('X-ANT-RESOURCE',   resource)
                               .setRequestHeader('X-ANT-PROCESS',    'delete')
                        },
                        success: function(result) {
                            if (result.status == 'success') {
                                window.location.reload();
    ...
    clearSearch : function(resource) {
        ...
        $.ajax({
            ...
            beforeSend: function(xhr) {
                xhr.setRequestHeader('X-ANT-CSRF-TOKEN', token)
                   .setRequestHeader('X-ANT-RESOURCE',   resource)
                   .setRequestHeader('X-ANT-PROCESS',    'clear_search')
            },
            success: function(result) {
                if (result.status == 'success') {
                    window.location.reload();
    ...
    searchData : function(resource, form) {
        ...
        $.ajax({
            ...
            beforeSend: function(xhr) {
                xhr.setRequestHeader('X-ANT-CSRF-TOKEN', token)
                   .setRequestHeader('X-ANT-RESOURCE',   resource)
                   .setRequestHeader('X-ANT-PROCESS',    'search')
            },
            success: function(result) {
                if (result.status == 'success') {
                    window.location.reload();
    ...
    recordsPerPage : function(resource, select) {
        ...
        $.ajax({
            ...
            beforeSend: function(xhr) {
                xhr.setRequestHeader('X-ANT-CSRF-TOKEN', token)
                   .setRequestHeader('X-ANT-RESOURCE',   resource)
                   .setRequestHeader('X-ANT-PROCESS',    'records_per_page')
            },
